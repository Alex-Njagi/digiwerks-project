...
const ArtistSignupChart = ({ artists }) => {
  const theme = useTheme();

  const getMonthlySignups = (artists) => {
    const counts = {};
  ...
  const data = getMonthlySignups(artists);
    ...
    >
      ...
      <ResponsiveContainer width="100%" height={300}>
        <LineChart data={data}>
          ...
          <XAxis dataKey="month" tick={{ fill: theme.colors.brand.blue }} />
...
export default ArtistSignupChart;
